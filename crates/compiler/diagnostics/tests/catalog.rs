...
fn catalog_is_sorted_unique_and_partitioned_by_compiler_phase() {
    ...
    assert_eq!(
        ...
        [
            ...
            "POP4001", "POP4002", "POP4003", "POP4004", "POP4005", "POP4006", "POP4007", "POP6400",
            "POP6401", "POP6402", "POP6403", "POP6404", "POP6405", "POP6406", "POP6407", "POP6408",
            "POP7000", "POP7001", "POP7002", "POP7003", "POP7004", "POP7005", "POP7006", "POP7007",
            "POP7008", "POP7009"
        ]
    );
    ...
    assert!(entries[..47].iter().all(|entry| !entry.is_suppressible()));
    assert!(entries[47..56].iter().all(|entry| {
    ...
    assert!(entries[56..].iter().all(|entry| {
