...
impl RuntimeOperation {
    ...
    pub const fn abi_symbol(self) -> &'static str {
        match self {
            ...
            Self::AllocateArrayFilled => "pop_rt_allocate_array_filled",
            Self::AllocateTable => "pop_rt_allocate_table",
            Self::TupleMake => "pop_rt_tuple_make",
            Self::ArrayGet => "pop_rt_array_get",
            Self::ArrayLength => "pop_rt_array_length",
            Self::ArrayGetChecked => "pop_rt_array_get_checked",
            Self::ArraySet => "pop_rt_array_set",
            Self::ArrayFill => "pop_rt_array_fill",
