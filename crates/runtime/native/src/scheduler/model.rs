...
pub struct SchedulerTelemetry {
    ...
    pub(super) blocking_shutdowns: u64,
    pub(super) blocking_shutdown_delay: SchedulerDelayTelemetry,
    pub(super) timers_scheduled: u64,
    pub(super) timers_delivered: u64,
    pub(super) timer_polls: u64,
    pub(super) timer_delivery_delay: SchedulerDelayTelemetry,
    ...
    pub(super) external_event_polls: u64,
    pub(super) external_event_delivery_delay: SchedulerDelayTelemetry,
...
impl SchedulerTelemetry {
    telemetry_accessors! {
        ...
        blocking_panics: u64,
        blocking_shutdowns: u64,
        blocking_shutdown_delay: SchedulerDelayTelemetry,
        timers_scheduled: u64,
        timers_delivered: u64,
        timer_polls: u64,
        timer_delivery_delay: SchedulerDelayTelemetry,
        external_events_registered: u64,
        external_events_delivered: u64,
        external_event_signals_coalesced: u64,
        external_event_polls: u64,
        external_event_delivery_delay: SchedulerDelayTelemetry,
