...
use pop_standard::{
    ...
    pop_std_net_tcp_receive_raw, pop_std_net_tcp_send_all_raw, pop_std_print_int,
    pop_std_print_string, pop_std_task_cancel_source_cancel,
    pop_std_task_cancel_source_cancellation_requested, print_string,
};
...
fn native_output_adapters_keep_the_bootstrap_signatures() {
    ...
    assert_eq!(NATIVE_EXPORTS.len(), 9);
